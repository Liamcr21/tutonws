...
class CommentController extends AbstractController
{
    ...
    public function add(Request $request, EntityManagerInterface $em, CommentRepository $commentRepo, UserRepository $userRepo, ArticleRepository $articleRepo): Response
    {   
